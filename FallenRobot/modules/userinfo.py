...
def info(update: Update, context: CallbackContext):
    ...
    if user_id not in [bot.id, 777000, 6090419276]:
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/GORILLA_NETWORK"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/GORRILA_SUPPORT"
                            ),
                        ],
                    ]
                ),
...
def set_about_me(update: Update, context: CallbackContext):
    ...
    if user_id in [777000, 6090419276]:
    ...
    if message.reply_to_message:
        ...
        if repl_user_id in [bot.id, 777000, 6090419276] and (user_id in DEV_USERS):
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id in [777000, 6090419276] and sender_id not in DEV_USERS:
